        ...
        <div style={{ lineHeight: '1.8', fontSize: '1.05rem' }}>
          <section style={{ marginBottom: '4rem', padding: '2rem', background: 'rgba(10, 2, 2, 0.5)', borderRadius: '12px' }}>
            ...
            <p style={{ marginBottom: '1rem' }}>
              We believe that in a world where images can be easily manipulated, there must be reliable 
              mechanisms to verify authenticity. StegaShield combines advanced steganography techniques with 
              comprehensive detection methods to create a solution for media authentication.
            </p>
          </section>
          ...
          <section style={{ marginBottom: '4rem', padding: '2rem', background: 'rgba(10, 2, 2, 0.5)', borderRadius: '12px' }}>
            ...
            <p style={{ marginBottom: '1rem' }}>
              Our detection methods analyze visual artifacts and inconsistencies to identify manipulated content 
              through pattern recognition and signal analysis techniques.
            </p>
          </section>
