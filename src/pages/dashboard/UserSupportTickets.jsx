...
export default function UserSupportTickets() {
  ...
  const handleCreateTicket = async (e) => {
    ...
    try {
      await chatsAPI.createChat(formData.subject, formData.description, formData.priority);
      setMessage('Chat created successfully! We will respond soon.');
      setShowMessage(true);
            ...
            {tickets.map(ticket => {
              ...
              return (
                ...
                >
                  ...
                  {selectedTicket?.chat_id === (ticket.chat_id || ticket.ticket_id) && (
                  ...
                  {!selectedTicket || selectedTicket.chat_id !== (ticket.chat_id || ticket.ticket_id) ? (
